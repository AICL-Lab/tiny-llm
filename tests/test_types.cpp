...
RC_GTEST_PROP(QuantizedWeightProperty, TotalBytesIsCorrect, (int rows, int cols, int group_size)) {
...
RC_GTEST_PROP(QuantizedWeightProperty, GroupSizeAffectsScaleSize, (int rows, int cols)) {
