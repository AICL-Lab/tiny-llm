...
[English](README.md) • [简体中文](README.zh-CN.md) • [文档](https://aicl-lab.github.io/tiny-llm/) • [架构说明](https://aicl-lab.github.io/tiny-llm/zh/architecture/) • [API](https://aicl-lab.github.io/tiny-llm/zh/api/) • [更新日志](CHANGELOG.md)
...
提交改动前请先阅读 [CONTRIBUTING.md](CONTRIBUTING.md)。保持改动聚焦、让文档与真实运行时边界一致，并避免重新引入重复的流程脚手架。
